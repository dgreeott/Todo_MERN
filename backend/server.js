...
const DB_USER = 'drakegreeott';

const PASSWORD = encodeURIComponent('NUMVPy8tOCYzCNhH');

const url = `mongodb+srv://${DB_USER}:${PASSWORD}@cluster0.zjdej.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
